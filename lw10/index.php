...
<body>
  ...
  <div class="main-container">
    <div class="part-one">
      <div class="part-one__wrapper">
        ...
        <div class="quote-container">
          ...
          <h1 class="quote-container__name">Jane Doe</h1>
        </div>
      </div>
      <div class="part-one__wrapper">
    ...
    <div class="part-two">
      <div class="film-container">
        ...
        <div class="film-columns">
          <a class="film-columns__slider film-columns__slider_previous" id="prev">&#10094;</a>
          <a class="film-columns__slider film-columns__slider_next" id="next">&#10095;</a>
    ...
    <form class="form" id="form" method="POST">
      ...
      <textarea class="form__input form__text" name="text" id="message"></textarea>
      <div class="form__title form__feedback" id="done">Ваше сообщение успешно отправлено!</div>
